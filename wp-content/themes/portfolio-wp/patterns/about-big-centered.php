<?php
/**
 * Title: About Big Centered
 * Slug: portfolio-wp/about-big-centered
...
<div class="wp-block-group"><!-- wp:group {"style":{"border":{"radius":"8px"},"spacing":{"padding":{"top":"4px","bottom":"4px","left":"var:preset|spacing|50","right":"var:preset|spacing|50"}}},"backgroundColor":"accent-primary","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-accent-primary-background-color has-background" style="border-radius:8px;padding-top:4px;padding-right:var(--wp--preset--spacing--50);padding-bottom:4px;padding-left:var(--wp--preset--spacing--50)"><!-- wp:heading {"textAlign":"center","level":6,"style":{"elements":{"link":{"color":{"text":"var:preset|color|dark-gray"}}},"spacing":{"padding":{"top":"var:preset|spacing|30","bottom":"var:preset|spacing|30"}},"typography":{"fontStyle":"normal","fontWeight":"500"}},"textColor":"dark-gray","className":"highlighter","fontSize":"normal"} -->
<h6 class="wp-block-heading has-text-align-center highlighter has-dark-gray-color has-text-color has-link-color has-normal-font-size" style="padding-top:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30);font-style:normal;font-weight:500">About</h6>
<!-- /wp:heading --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<h2 class="wp-block-heading has-text-align-center has-humongous-font-size">I can help you stand out and <span style="text-decoration: underline;">make the website of your dreams.</span></h2>
<!-- /wp:heading -->
...
<div class="wp-block-button has-custom-font-size is-style-outline has-medium-font-size"><a class="wp-block-button__link wp-element-button" style="border-width:2px">Get In Touch</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->