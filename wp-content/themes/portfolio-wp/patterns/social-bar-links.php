<?php
/**
 * Title: Social Bar Links
 * Slug: portfolio-wp/social-bar-links
...
<div class="wp-block-group alignfull social-pattern" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)"><!-- wp:columns {"verticalAlignment":"center","align":"wide"} -->
...
<h4 class="wp-block-heading has-extra-large-font-size" style="font-style:normal;font-weight:600"><mark style="background-color:#FDF800" class="has-inline-color">Follow us.</mark></h4>
<!-- /wp:heading --></div>
<!-- /wp:column -->
