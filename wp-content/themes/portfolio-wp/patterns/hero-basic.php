...
<h2 class="wp-block-heading" style="font-size:5.8rem;letter-spacing:0px;line-height:1.3">Hey, <span style="font-size: 90%;">👋</span><br>We're <span class="highlighter">Portfolio WP.</span></h2>
<!-- /wp:heading -->
...
<p style="font-size:1.25rem">A portfolio theme designed to highlight your talent and engage your audience. Packed with expertly designed Blocks and Patterns to showcase your work in the best light.</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button has-custom-font-size" style="font-size:1.3rem"><a class="wp-block-button__link wp-element-button">Download For Free</a></div>
<!-- /wp:button -->

<!-- wp:button {"style":{"border":{"width":"2px"},"typography":{"fontSize":"1.3rem"}},"className":"is-style-outline"} -->
<div class="wp-block-button has-custom-font-size is-style-outline" style="font-size:1.3rem"><a class="wp-block-button__link wp-element-button" style="border-width:2px">Get Pro and Get More</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column -->
