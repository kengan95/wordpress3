<?php
/**
 * Title: Social Link Group
 * Slug: portfolio-wp/social-link-group
...
<h4 class="wp-block-heading has-text-align-center has-extra-large-font-size" style="font-style:normal;font-weight:600">Say hi or internet <mark style="background-color:#FDF800" class="has-inline-color">stalk us s'more.</mark></h4>
<!-- /wp:heading -->
...
<!-- wp:paragraph -->
<p><strong><a href="#">Dribbble</a></strong></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p><strong><a href="#">Email</a></strong></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->